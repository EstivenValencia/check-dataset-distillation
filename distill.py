...
def main(args):
    ...
    for it in range(0, args.Iteration+1):
        ...
        for step in range(args.syn_steps):
            ...
            size_in_bytes = sum(tensor.element_size() * tensor.numel() for tensor in student_params)
            
            # Convertir a KB o MB
            size_in_kb = size_in_bytes / 1024
            size_in_mb = size_in_kb / 1024
            
            print(f"Peso en memoria: {size_in_bytes} bytes ({size_in_kb:.2f} KB, {size_in_mb:.2f} MB)")
